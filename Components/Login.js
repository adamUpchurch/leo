...
export default class Login extends Component {
    ...
    webAuth() {
        auth0
            .webAuth
                .authorize({scope: 'openid profile email', audience: 'https://read-leo.auth0.com/userinfo'})
                .then(credentials =>
        ...
        return (
            <KeyboardAvoidingView behavior="padding" style={styles.container}>
                <View style={styles.headerContainer}>
                    <Image
                        style={styles.logo}
                        source={require('../ios/Leo_ios/Images.xcassets/AppIcon.appiconset/icon_spotlight_3x.png')}
                    />
