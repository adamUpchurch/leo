  ...
  render() {
    ...
    return (
      <BookList books={this.state.Books}/>
          ...
          // <ScrollView style={styles.container}>
          //     <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books[0]})}>
          //       <View style={styles.bookContainer}>
          ...
          //         <View style={styles.bookTile}>
          //           <Text style={styles.bookTileText}>{this.state.Books[0].title}</Text>
          //           <Text style={styles.bookTileSummary}>{this.state.Books[0].author}</Text>
          //           <Text style={styles.bookTileSummary}>{this.state.Books[0].summary}</Text>
          //         </View>
          //       </View>
          //     </TouchableWithoutFeedback>                
          //     <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books[1]})}>
          //         <View style={styles.bookContainer}>
          //           <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'http://prodimage.images-bn.com/pimages/9780142410318_p0_v4_s1200x630.jpg'}}/>
          //           <View style={styles.bookTile}>
          //             <Text style={styles.bookTileText}>{this.state.Books[1].title}</Text>
          //             <Text style={styles.bookTileSummary}>{this.state.Books[1].author}</Text>
          //             <Text style={styles.bookTileSummary}>{this.state.Books[1].summary}</Text>
          //           </View>
          //         </View>
          //     </TouchableWithoutFeedback>
          // </ScrollView>
