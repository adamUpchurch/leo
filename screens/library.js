  ...
  render() {
    ...
    return (
          <ScrollView style={styles.container}>
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Thrones})}>
                <View style={styles.bookContainer}>
                      <Image style={{width: 50, height: 80, marginRight: 10}} source={{uri: 'https://images-na.ssl-images-amazon.com/images/I/51DA1hQNnJL._SX324_BO1,204,203,200_.jpg'}}/>
                  <View style={styles.bookTile}>
                    <Text style={styles.bookTileText}>{this.state.Books.Thrones.title}</Text>
                    <Text style={styles.bookTileSummary}>{this.state.Books.Thrones.author}</Text>
                    <Text style={styles.bookTileSummary}>{this.state.Books.Thrones.summary}</Text>
                  </View>
                </View>
              </TouchableWithoutFeedback>                
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Charlie})}>
                  <View style={styles.bookContainer}>
                    <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'http://prodimage.images-bn.com/pimages/9780142410318_p0_v4_s1200x630.jpg'}}/>
                    <View style={styles.bookTile}>
                      <Text style={styles.bookTileText}>{this.state.Books.Charlie.title}</Text>
                      <Text style={styles.bookTileSummary}>{this.state.Books.Charlie.author}</Text>
                      <Text style={styles.bookTileSummary}>{this.state.Books.Charlie.summary}</Text>
                    </View>
                  </View>
                </TouchableWithoutFeedback>
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Charlie})}>
                <View style={styles.bookContainer}>
                      <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'https://pictures.abebooks.com/isbn/9781780891262-us.jpg'}}/>
                  <View style={styles.bookTile}>
                    <Text style={styles.bookTileText}>50 Shades of Grey</Text>
                    <Text style={styles.bookTileSummary}>E.L. James</Text>
                    <Text style={styles.bookTileSummary}>Proves that chicks are as horny as dudes.</Text>
                  </View>
                </View>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Charlie})}>
                <View style={styles.bookContainer}>
                        <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'https://kbimages1-a.akamaihd.net/96634076-1c91-4fa9-9518-41c5bfa3e59f/353/569/90/False/harry-potter-and-the-sorcerer-s-stone-the-first-book-in-the-phenomenal-internationally-bestselling-harry-potter-series-by-j-k-rowling.jpg'}}/>
                  <View style={styles.bookTile}>
                    <Text style={styles.bookTileText}>Harry Potter and the Sorcerer's Stone</Text>
                    <Text style={styles.bookTileSummary}>J.K. Rowling</Text>
                    <Text style={styles.bookTileSummary}>It's about a boy going through puberty but with magic.</Text>
                  </View>
                </View>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Charlie})}>
                <View style={styles.bookContainer}>
                        <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/1914%2C_Niebla_%28nivola%29%2C_editoral_Renacimiento%2C_Miguel_de_Unamuno.jpg/220px-1914%2C_Niebla_%28nivola%29%2C_editoral_Renacimiento%2C_Miguel_de_Unamuno.jpg'}}/>
                  <View style={styles.bookTile}>
                    <Text style={styles.bookTileText}>Niebla</Text>
                    <Text style={styles.bookTileSummary}>Miguel de Unamuno</Text>
                    <Text style={styles.bookTileSummary}>I have no idea.</Text>
                  </View>
                </View>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Charlie})}>
                <View style={styles.bookContainer}>
                          <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'https://upload.wikimedia.org/wikipedia/en/thumb/3/33/ObsceneBirdOfNight.jpg/220px-ObsceneBirdOfNight.jpg'}}/>
                  <View style={styles.bookTile}>
                    <Text style={styles.bookTileText}>El obsceno pájaro de la noche</Text>
                    <Text style={styles.bookTileSummary}>José Donoso</Text>
                    <Text style={styles.bookTileSummary}>Something about the night.</Text>
                  </View>
                </View>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Charlie})}>
                <View style={styles.bookContainer}>
                          <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'https://www.basicbooks.com/wp-content/uploads/2017/09/9780465013272.jpg?fit=411%2C630'}}/>
                  <View style={styles.bookTile}>
                    <Text style={styles.bookTileText}>The Art of War</Text>
                    <Text style={styles.bookTileSummary}>Sun Tzu</Text>
                    <Text style={styles.bookTileSummary}>Quotes about stuff that could have to do with killing people.</Text>
                  </View>
                </View>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Charlie})}>
                <View style={styles.bookContainer}>
                          <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'https://cdn.heleo.com/wp-content/uploads/2015/11/06161140/the-lean-startup-book-cover.png'}}/>
                  <View style={styles.bookTile}>
                    <Text style={styles.bookTileText}>The Lean Startup</Text>
                    <Text style={styles.bookTileSummary}>Eric Reis</Text>
                    <Text style={styles.bookTileSummary}>Weightwatchers for starting a company.</Text>
                  </View>
                </View>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback onPress={() => navigate('Reading', {book: this.state.Books.Charlie})}>
                <View style={styles.bookContainer}>
                          <Image style={{width: 50, height: 80, marginTop: 10, marginRight: 10}} source={{uri: 'https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9780/0071/9780007158447.jpg'}}/>
                  <View style={styles.bookTile}>
                    <Text style={styles.bookTileText}>The Cat in the Hat</Text>
                    <Text style={styles.bookTileSummary}>Dr. Seuss</Text>
                    <Text style={styles.bookTileSummary}>A fucking cat in a fucking hat.</Text>
                  </View>
                </View>
              </TouchableWithoutFeedback>
          </ScrollView>
